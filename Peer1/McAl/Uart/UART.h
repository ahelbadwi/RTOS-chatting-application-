...
typedef struct 
{
	...
	uint8 u8_DataSize;
	uint32 u32_BaudRate;
	ErrorStatus_t (*Transmit_Cbk_ptr)(void);
	ErrorStatus_t (*Receive_Cbk_ptr)(void);
	ErrorStatus_t (*DataRegisterEmpty_Cbk_ptr)(void);
}UART_cfg_s;
 ...
 *
 **/     
extern ErrorStatus_t UART_Init(UART_cfg_s *pUART_cfg_s);
 ...
 *
 **/     
extern ErrorStatus_t UART_Deinit(void);
 ...
 *
 **/  
extern ErrorStatus_t UART_SendByte(uint8 u8_Data);
 ...
 *
 **/  
extern ErrorStatus_t UART_ReceiveByte(uint8 *pu8_ReceivedData);
